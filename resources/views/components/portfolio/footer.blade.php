<!-- Footer -->
<footer class="relative xl:ml-72 bg-slate-900 border-t border-slate-800">
    <!-- Wave Separator -->
    <div class="absolute top-0 left-0 right-0 transform -translate-y-full overflow-hidden">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="w-full h-12 md:h-20">
            <path
                ...
                fill="currentColor" class="text-slate-800"></path>
        </svg>
    </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="#hero"
                            class="text-gray-400 hover:text-cyan-400 transition-colors duration-300 flex items-center gap-2">
            ...
            <div>
                ...
                <!-- Status Badge -->
                <div class="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-full glass">
                    <span class="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
                    <span class="text-green-400 text-sm font-medium">Available for work</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Back to Top Button -->
    <a href="#hero"
        class="fixed bottom-8 right-8 w-12 h-12 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 flex items-center justify-center text-white shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transform hover:-translate-y-1 transition-all duration-300 z-50 opacity-0 invisible"
        id="backToTop">
