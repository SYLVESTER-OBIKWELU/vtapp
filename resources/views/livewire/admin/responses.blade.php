                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr wire:key='{{$response->id}}' class="border-b dark:border-gray-700">
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{$count++}}
                                </td>
                                <td class="px-4 py-3">{{$response->message->ip}}</td>
                                <td class="px-4 py-3">{{$response->email}}</td>
                                <td class="px-4 py-3">{{$response->message->subject}}</td>
                                <td class="px-4 py-3">
                                ...
                                <td class="px-4 py-3">{{$response->created_at->diffForHumans()}}</td>
                                <td class="px-4 py-3">
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="flex justify-center items-center text-gray-700 dark:text-white p-5"
                                        ...
                                        You have not made any response yet.
                                    </div>
                                </td>
                            </tr>
                            @endif
