    ...
    <section id="contact" class="relative py-24 xl:ml-72 overflow-hidden">
        ...
        <div class="container relative mx-auto px-6 lg:px-12">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-gray-400 max-w-2xl mx-auto">Have a question or want to work together? I'd love to hear
                    from
                    you!</p>
            ...
            <div class="grid lg:grid-cols-5 gap-12">
                ...
                <div class="lg:col-span-2 space-y-6" wire:ignore>
                    <div class="glass rounded-2xl p-8 h-full">
                        ...
                        <p class="text-gray-400 mb-8">Feel free to reach out. I'm always open to discussing new
                            projects,
                            ...
                            <div class="flex items-start gap-4 group">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+2347018508896"
                                        class="text-gray-400 hover:text-purple-400 transition-colors">+234
                                        7018508896</a>
                                </div>
                            </div>
                        ...
                        <form wire:submit.prevent="sendMessage" class="space-y-6">
                            <div class="grid sm:grid-cols-2 gap-6">
                                ...
                                <div class="form-group">
                                    <label for="name" class="block text-gray-300 text-sm font-medium mb-2">Your
                                        Name</label>
                                    <div class="relative">
                                        ...
                                        <i
                                            class="bi bi-person absolute right-4 top-1/2 -translate-y-1/2 text-gray-500"></i>
                                    </div>
                                    @error('name')
                            ...
                            <!-- Submit Button -->
                            <button type="submit" class="btn-modern w-full sm:w-auto" wire:loading.attr="disabled"
                                wire:loading.class="opacity-75 cursor-not-allowed">
                                <span class="relative z-10 flex items-center justify-center gap-2">
                                    <i class="bi bi-send" wire:loading.remove wire:target="sendMessage"></i>
                                    <i class="bi bi-arrow-repeat animate-spin" wire:loading
                                        wire:target="sendMessage"></i>
