        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-lg text-gray-400">
                    Ready to elevate your digital presence? Share your project details and let our expert team craft a
                        ...
                        <form wire:submit.prevent="sendMessage" class="space-y-6">
                            <div class="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model="name" class="form-input-modern"
